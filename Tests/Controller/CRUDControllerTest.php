...
namespace Bluemesa\Bundle\CoreBundle\Tests\Controller;

use Bluemesa\Bundle\CoreBundle\Entity\Entity;
use Bluemesa\Bundle\CoreBundle\Filter\SecureListFilter;
...
class CRUDControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    */
    ...
    public function testDeleteAction()
    {
        ...
        $this->assertArrayHasKey('entity', $result);
        $this->assertInstanceOf('Bluemesa\Bundle\CoreBundle\Entity\Entity',$result['entity']);
    }
    ...
    */
    ...
    private function getFakeController()
    {
        ...
        $controller =
                $this->getMockBuilder('Bluemesa\Bundle\CoreBundle\Controller\CRUDController')
                     ->setMethods($methods)
        ...
        $controller->expects($this->any())
            ...
            ->will($this->returnValue('Bluemesa\Bundle\CoreBundle\Entity\Entity'));
        $controller->expects($this->any())
    ...
    {
        $map = array(
          array('Bluemesa\Bundle\CoreBundle\Entity\Entity', 0, null, null),
          array('Bluemesa\Bundle\CoreBundle\Entity\Entity', 1, null, new Entity())
        );

        $om = $this->getMockBuilder('Bluemesa\Bundle\CoreBundle\Doctrine\ObjectManager')
            ->disableOriginalConstructor()
            ->getMock();
        $om->expects($this->any())
